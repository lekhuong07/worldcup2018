...
France     (W% = 92.9)   3 - 1    Croatia  (W% = 7.1)

Uruguay    (W% = 35.4)   1 - 2    Portugal (W% = 64.6)

Brazil     (W% = 92.1)   4 - 1    Mexico   (W% = 7.9)

Belgium(W) (W% = 54.8)   2 - 2    Colombia (W% = 45.2)

Right brackets:

Spain        (W% = 90)    4 - 2    Russia      (W% = 10)

Argentina(W) (W% = 59.9)  2 - 2    Denmark     (W% = 40.1)

Germany      (W% = 95.5)  4 - 2    Switzerland (W% = 4.5)

Poland       (W% = 35.5)  2 - 1    England     (W% = 64.5)

Quarterfinals:

Left brackets:

France  (W% = 90.44)    3 - 2    Portugal (W% = 9.56)

Brazil  (W% = 87.8)     3 - 2    Belgium  (W% = 12.2)

Right brackets:

Germany(W) (W% = 52.02)  2 - 2    England  (W% = 47.98)

Spain(W)   (W% = 50.3)  2 - 2    Argentina (W% = 49.7)

Semifinals:

France  (W% = 42.76)  2 - 2    Brazil(W)  (W% = 57.24)

Spain   (W% = 46.42)  2 - 2    Germany(W) (W% = 53.58)

Finals:
Brazil(W) (W% = 42.76)    2 - 2    Germany (W% = 42.76)