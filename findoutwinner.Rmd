...
match61 = data.frame(team1 = c("France"), team2 = c("Brazil"), played = c(15), fraW = c(6), draw = c(3), braW = c(6), FRA_gs = c(fra_gssf), BRA_gs = c(bra_gssf), avggfra_gs = c(fra_gssf), avggfra_gc = c(fra_gcsf), avggbra_gs = c(bra_gssf), avggbra_gc = c(bra_gcsf))
#france gs = cro_gc
...
Matchup : Not looking at history matchup, using gs throughout tournament instead.
...
match62 = data.frame(team1 = c("Germany"), team2 = c("Spain"), played = c(23), gergW = c(9), draw = c(7), espW = c(7), GER_gs = c(ger_gssf), ESP_gs = c(esp_gssf), avggger_gs = c(ger_gssf), avggger_gc = c(ger_gcsf), avggesp_gs = c(esp_gssf), avggesp_gc = c(esp_gcsf))
...
```
Germany 1 - 1 Spain Germany win on penalty

Finals Brazil vs Germany: Not looking at history matchup, using gs throughout tournament instead.
```{r}
m = 5000
set.seed(1602)
...
France  (W% = 48.82)  2 - 2    Brazil(W)  (W% = 51.18)

Spain   (W% = 49.34)  2 - 2    Germany(W) (W% = 50.66)

Finals:
Brazil (W% = 47.84)   1 - 1    Germany(W) (W% = 52.16)